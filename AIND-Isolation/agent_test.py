...
class Project1Test(unittest.TestCase):
    ...
    def test_get_move(self):
        ...
        for idx in range(len(origins)):
            ...
            self.assertTrue(diff_total <= 1 and diff_unique == 0, ID_FAIL.format(board.counts[0], exact_counts[idx][0], board.counts[1], exact_counts[idx][1] ))
